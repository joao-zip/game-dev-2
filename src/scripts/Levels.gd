...
func _on_level_5_button_up():
	get_tree().change_scene("res://levels/level_5/level_5.tscn")
	
	
func _on_level_7_button_up():
	get_tree().change_scene("res://levels/level_7/level_7.tscn")


func _on_level_9_button_up():
	get_tree().change_scene("res://levels/level_9/level_9.tscn")
